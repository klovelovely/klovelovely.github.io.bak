...
(function ($) {
    ...
    function gotoStep(objResult) {
        ...
        setTimeout(function () {
            (function () {
                ...
                showGift(hasGift, currentGift, nextGift, objResult);
     ...
     */
    function showGift(hasGift, currentGift, nextGift, objResult) {
        ...
        if (hasGift) { // 当前步骤上有礼物
            ...
            if (nextGift && nextGift.giftName != "") { // 提示距离下一个礼物还有 x 步, 显示下一个即将获得的礼物的信息
